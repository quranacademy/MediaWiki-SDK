...
trait AuthTrait
{
     ...
     * @throws ApiException
     */
    public function login(?string $language = null, ?string $domain = null): bool
    {
        $language = $language ?? $this->project->getDefaultLanguage();
     ...
     */
    public function logout($languages = null): void
    {
     ...
     * @return bool
     */
    public function isLoggedIn($language = null): bool
    {
